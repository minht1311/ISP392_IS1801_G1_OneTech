                    ...
                    <div class="col-md-7 col-lg-5">
                        <div class="wrap">
                            <div class="login-wrap p-4 p-md-5">
                                ...
                                <form action="VerifyCodeForgot" method="post" class="signin-form">
                                    <div class="form-group mt-3">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="authcode" required>
                                            <label class="form-control-placeholder">Code</label>
                                        </div>
                                        <div class="form-group">
                                ...
                                <p class="text-center">No CODE sent? <a href="ResendMailFP" id="resendLink">Resend</a></p>
